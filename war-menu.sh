...
echo -e "   ${YLW}?${RST} Verify: /landing /pricing  ${YLW}?${RST} OpenRouter key needed"
echo -e "   ${RED}!${RST} Publish: Reddit + X thread ${RED}!${RST} Payments: Stripe pending"
echo ""
echo -e "${WHT}  NEXT ACTIONS${RST}"
echo -e "   ${DIM}1. Verify Vercel pages load  2. Get OpenRouter key (free)${RST}"
echo -e "   ${DIM}3. Publish Reddit + X thread 4. Setup Stripe payments${RST}"
echo ""
